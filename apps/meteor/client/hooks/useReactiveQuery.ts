import { IMessage, IRole, IRoom, ISubscription, IUser } from '@rocket.chat/core-typings';
import { useQuery, UseQueryOptions, QueryKey, UseQueryResult, useQueryClient } from '@tanstack/react-query';
import { Mongo } from 'meteor/mongo';
import { Tracker } from 'meteor/tracker';

import { Messages, Roles, RoomRoles, Rooms, Subscriptions, Users } from '../../app/models/client';
...
const queryableCollections = {
	...
	messages: Messages as Mongo.Collection<IMessage>,
} as const;
